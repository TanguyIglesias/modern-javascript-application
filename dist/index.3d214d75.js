...
var _meteoJs = require("./meteo.js");
var _comparaisonJs = require("./comparaison.js");
document.querySelector("#input-town").addEventListener("keyup", (e)=>{
    if (e.keyCode === 13) (0, _meteoJs.meteo)();
});
document.querySelector("#button-town").addEventListener("click", (0, _meteoJs.meteo));
document.querySelector("#input-town2").addEventListener("keyup", (event)=>{
    if (event.keyCode === 13) (0, _comparaisonJs.comparaison)();
});
document.querySelector("#button-town2").addEventListener("click", (0, _comparaisonJs.comparaison));

},{"./meteo.js":"lbAKi","./comparaison.js":"eDsyY"}],"lbAKi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "meteo", ()=>meteo);
let meteo = ()=>{
    ...
    fetch(url).then((response)=>response.json()).then((data)=>{
        ...
        if (typeof data.main === "undefined") {
            let error = "<h2 class='error'>Cette ville n'est pas r\xe9pertori\xe9e</h2>";
            ...
            let affichage = `<div class="cityName">
                ...
                <div class="temps">
                <p>${Math.floor(Math.ceil(data.main.temp))} °C</p><p> ${data.weather[0].description}</p>
                </div>
                </div>`;
            document.querySelector("#meteo-curr").innerHTML = affichage;
            let windSpeed = Math.round(data.wind.speed * 3.6);
            let meteoAjd = `<ul>
                <li class="location">Météo aujourd'hui à ${data.name}, ${data.sys.country}</li>
                <li class="Tressenti"> <div class="Tressenti-temp">${Math.floor(Math.ceil(data.main.temp))} °</div> <div class="Tressenti-index"> T.ressentie</li>
                <li class="meteo"> 
...
},{}],"eDsyY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "comparaison", ()=>comparaison);
let comparaison = ()=>{
    let key = "adc743d149ca38cafb6f5022f11f69dc";
    let city = document.querySelector("#input-town").value;
    ...
    fetch(url).then((response)=>response.json()).then((data)=>{
        ...
        if (typeof data.main === "undefined") {
            ...
            document.querySelector("#table-city1").innerHTML = comparaison1;
        }
    });
    fetch(url2).then((response)=>response.json()).then((data)=>{
        ...
        if (typeof data.main === "undefined") {
            ...
            document.querySelector("#table-city2").innerHTML = comparaison2;
        }
    });
};
